...
public class StringHelperNew {
    public static boolean areWordsEqual(String firstWord, String secondWord, boolean isCaseSensitive) {
        if (firstWord.contains(" ") || secondWord.contains(" ")) throw new RuntimeException("Parameters contain whitespaces.");
    ...
    public static boolean areSentencesEqual(String firstSentence, String secondSentence, boolean isCaseSensitive) {
        return isCaseSensitive == true ? (firstSentence.equals(secondSentence)) : firstSentence.equalsIgnoreCase(secondSentence);
    }

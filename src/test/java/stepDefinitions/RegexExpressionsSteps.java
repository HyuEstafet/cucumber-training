...
public class RegexExpressionsSteps {
    ...
    public void verify_if_the_words_are_same_or_not() {
        ...
        assertTrue(StringHelperNew.areWordsEqual(wordOne,wordTwo,isCaseSensitive),"The two give words are not equal and not the same!");
    }
    ...
    public void verify_if_the_sentences_are_the_same_or_not() {
        ...
        assertTrue(StringHelperNew.areSentencesEqual(sentenceOne,sentenceTwo,isCaseSensitive),"The two give words are not equal and not the same!");
    }
    ...
    public void count_the_words() {
        countedWordsTotal = StringHelperNew.getWordsCountFromText(givenText);
    }
